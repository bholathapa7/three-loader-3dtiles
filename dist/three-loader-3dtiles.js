(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('three/examples/jsm/loaders/GLTFLoader.js'), require('three/examples/jsm/loaders/DRACOLoader.js'), require('three/examples/jsm/loaders/KTX2Loader.js')) :
    typeof define === 'function' && define.amd ? define(['exports', 'three', 'three/examples/jsm/loaders/GLTFLoader.js', 'three/examples/jsm/loaders/DRACOLoader.js', 'three/examples/jsm/loaders/KTX2Loader.js'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ThreeLoader3DTiles = {}, global.THREE, global.THREE, global.THREE, global.THREE));
}(this, (function (exports, three, GLTFLoader_js, DRACOLoader_js, KTX2Loader_js) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function loadersPlaneToMesh(plane) {
        ...
        const arrowHelper = new three.ArrowHelper(normal, coplanarPoint, 5, 0xffff00);
    ...
    function loadersBoundingBoxToMesh(tile) {
        ...
        const boxColor = new three.Color(redColor, 1.0, 0.0);
...
`;
    ...
    exports.PointCloudColoring = void 0;
    ...
    })(exports.PointCloudColoring || (exports.PointCloudColoring = {}));
    ...
    })(exports.Shading || (exports.Shading = {}));
    exports.GeoTransform = void 0;
    ...
    })(exports.GeoTransform || (exports.GeoTransform = {}));
    ...
    const defaultOptions = {
        ...
        skipLevelOfDetail: false,
        updateTransforms: true,
        shading: exports.Shading.FlatTexture,
        transparent: false,
        pointCloudColoring: exports.PointCloudColoring.White,
        pointSize: 1.0,
        worker: true,
        wireframe: false,
        debug: false,
        ...
        shaderCallback: null,
        geoTransform: exports.GeoTransform.Reset
    };
    /** 3D Tiles Loader */
    class Loader3DTiles {
        /**
        ...
        */
        static load(props) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const gltfLoader = new GLTFLoader_js.GLTFLoader();
                ...
                const tileTrasnform = new three.Matrix4();
                ...
                if (tileset.root.boundingVolume) {
                    if (tileset.root.header.boundingVolume.region) {
                        ...
                        options.geoTransform = exports.GeoTransform.WGS84Cartesian;
                    }
                ...
                let timer = 0;
                const lastCameraTransform = new three.Matrix4().makeTranslation(Infinity, Infinity, Infinity);
                ...
                if (options.geoTransform == exports.GeoTransform.Mercator) {
                ...
                else if (options.geoTransform == exports.GeoTransform.WGS84Cartesian) {
                ...
                function detectOrientation(tile) {
                    ...
                    const orientationMatrix = new three.Matrix4()
                        ...
                        .premultiply(new three.Matrix4().extractRotation(rootTransformInverse));
                    ...
                    if (!rotation.equals(new three.Euler())) {
                        ...
                        const pos = new three.Vector3(tileTrasnform.elements[12], tileTrasnform.elements[13], tileTrasnform.elements[14]);
                ...
                function updateResetTransform() {
                    if (options.geoTransform != exports.GeoTransform.WGS84Cartesian) {
                        ...
                        threeMat.copy(lastRootTransform).multiply(new three.Matrix4().copy(tileTrasnform).invert());
                ...
                return {
                    ...
                    runtime: {
                        ...
                        getLatLongHeightFromPosition: (position) => {
                            const cartographicPosition = tileset.ellipsoid.cartesianToCartographic(new three.Vector3().copy(position).applyMatrix4(new three.Matrix4().copy(threeMat).invert()).toArray());
                            return {
                        ...
                        update: function (dt, renderer, camera) {
                            ...
                            if (tileset && timer >= UPDATE_INTERVAL) {
                                if (!lastRootTransform.equals(root.matrixWorld)) {
                                    ...
                                    updateResetTransform();
                                    const rootCenter = new three.Vector3().setFromMatrixPosition(lastRootTransform);
                                    pointcloudUniforms.rootCenter.value.copy(rootCenter);
                ...
                gltfLoader.parse(tile.content.gltfArrayBuffer, tile.contentUrl ? tile.contentUrl.substr(0, tile.contentUrl.lastIndexOf('/') + 1) : '', (gltf) => {
                    ...
                    tileContent.traverse((object) => {
                        if (object instanceof three.Mesh) {
                            ...
                            else if (options.shading == exports.Shading.FlatTexture) {
                                object.material = unlitMaterial.clone();
                                originalMaterial.dispose();
                            }
                            if (options.shading != exports.Shading.ShadedNoTexture) {
    ...
    exports.Loader3DTiles = Loader3DTiles;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=three-loader-3dtiles.js.map
